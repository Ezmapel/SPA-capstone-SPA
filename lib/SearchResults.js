...
export function searchResults() {
  ...
  function runPatientViewDoc() {
    // console.log(this.id);
    state.PatientViewDoc.specificDocEmail = this.id;
    state.PatientViewDoc.specificDocDetails = state.SearchResults.results.filter(
      function (item) {
        return item.email == state.PatientViewDoc.specificDocEmail;
      }
    );
    // console.log("specificDocDetails", state.PatientViewDoc.specificDocDetails);
    // console.log("specificDocEmail", state.PatientViewDoc.specificDocEmail);
